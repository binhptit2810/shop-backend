      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 font-semibold text-gray-650 dark:text-gray-400">
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Trung tâm trợ giúp</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">BMart Blog</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">BMart Mall</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Hướng dẫn mua hàng</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Chính sách vận chuyển</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Trả hàng & Hoàn tiền</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-semibold text-gray-650 dark:text-gray-400">
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Giới thiệu BMart</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Tuyển dụng nhân tài</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Điều khoản dịch vụ</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Chính sách bảo mật</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Kênh người bán chính hãng</a></li>
              <li><a href="#" className="hover:text-primary hover:underline transition-all">Liên hệ với truyền thông</a></li>
            </ul>
          </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-3 gap-2.5">
                {["VISA", "MC", "JCB", "COD", "MOMO", "ZALO"].map((method, idx) => (
                  <span 
                    key={idx} 
                    className="bg-gray-50 dark:bg-zinc-900 border border-gray-150 dark:border-zinc-800 py-2 rounded-sm text-center font-black text-gray-750 dark:text-gray-300 text-[9px] shadow-xs select-none"
                  >
                    {method}
                  </span>
                ))}
              </div>
              <div className="flex items-center gap-2 text-green-600 dark:text-green-500 font-bold bg-green-50 dark:bg-green-950/20 p-2.5 rounded-sm border border-green-100 dark:border-green-950/50">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <div className="bg-gray-50 dark:bg-zinc-900 border border-gray-150 dark:border-zinc-800 p-2 rounded-sm flex items-center justify-center shadow-xs">
                <div className="w-16 h-16 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-zinc-800 dark:to-zinc-750 rounded-sm flex items-center justify-center font-bold text-gray-400 text-[10px] uppercase select-none">
                  QR Code
                </div>
              </div>
              <div className="flex flex-col gap-2 justify-center">
                <a href="#" className="bg-gray-50 hover:bg-gray-100 dark:bg-zinc-900 border border-gray-150 dark:border-zinc-855 px-3 py-2 rounded-sm text-[9px] font-black text-gray-700 dark:text-gray-300 shadow-xs text-center transition-colors">
                  App Store
                </a>
                <a href="#" className="bg-gray-50 hover:bg-gray-100 dark:bg-zinc-900 border border-gray-150 dark:border-zinc-855 px-3 py-2 rounded-sm text-[9px] font-black text-gray-700 dark:text-gray-300 shadow-xs text-center transition-colors">
                  Google Play
        ...
        <div className="mt-14 pt-8 border-t border-gray-150 dark:border-zinc-900 flex justify-between items-center flex-wrap gap-4 text-gray-400 font-bold text-[11px]">
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-primary transition-colors">Quốc gia & Khu vực: Việt Nam</a>
          </div>
        </div>
